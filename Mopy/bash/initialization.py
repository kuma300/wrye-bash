...
def init_dirs(bashIni_, personal, localAppData, game_info):
    ...
    dirs[u'mods'] = dirs[u'app'].join(u'Data')
    ...
    dirs[u'modsBash'], modsBashSrc = getLegacyPathWithSource(
        dirs[u'modsBash'], dirs[u'app'].join(u'Data', u'Bash'),
    ...
    keys = (u'modsBash', u'installers', u'converters', u'dupeBCFs', u'corruptBCFs',
            u'bainData', u'bsaCache')
    try:
