...
from exception import AbstractError, ArgumentError, MasterMapError, ModError, \
    StateError
...
class _AParser(object):
    ...
    Reading from mods:
     - This is the most complex part of this design - we offer up to two
       ...
       fp_types appropriately and override _read_record_fp to use this pass.
     - The second pass filters by record type and long FormID, and can choose
       ...
       stored in id_stored_info. You will have to set sp_types appropriately
       and override _is_record_useful and _read_record_sp to use this pass.
     - If you want to skip either pass, just leave fp_types / sp_types
       empty."""
    ...
    def _read_plugin_fp(self, loaded_mod):
        ...
        :param mod_file: The loaded mod to read from."""
    ...
    def _read_record_fp(self, record):
        ...
        matching the fp_types. If _context_needs_followup is true, this will be
        called on every record again during the second pass.
    ...
    def _read_record_sp(self, record):
        ...
        all records matching the sp_types. Unless _get_cur_record_info is
    ...
    def _should_write_record(self, new_info, cur_info):
        ...
        you may want to override this if you e.g. want to ignore some benign
...
class _PBashParser(_AParser):
    ...
    def _read_plugin_fp(self, loaded_mod):
        ...
        for mod_name in master_names:
            ...
            _fp_loop(self._load_plugin(bosh.modInfos[mod_name], self._fp_types))
...
class ActorFactions(_PBashParser):
    ...
    def __init__(self):
        ...
        fac_types = bush.game.factions_types
