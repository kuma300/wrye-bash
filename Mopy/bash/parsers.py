...
class ModFile(object):
    ...
    def __init__(self, fileInfo,loadFactory=None):
        ...
        #--Variables to load
        self.tes4 = bush.game_mod.records.MreTes4(RecordHeader())
    ...
    def load(self, do_unpack=False, progress=None, loadStrings=True):
        ...
        with ModReader(self.fileInfo.name,self.fileInfo.getPath().open('rb')) as ins:
            ...
            header = insRecHeader()
            self.tes4 = bush.game_mod.records.MreTes4(header,ins,True)
            ...
            while not insAtEnd():
                ...
                try:
                    if topClass:
                        ...
                        insSeek(size-RecordHeader.rec_header_size,1,type + '.' + label)
                except:
