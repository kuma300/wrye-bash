...
class Installer_Fomod(OneItemLink, _InstallerLink):
    ...
    def Execute(self):
        ...
        installer.extras_dict[u'fomod_active'] = True
        installer.extras_dict[u'fomod_files_dict'] = ret.install_files
...
class Installer_Install(_InstallLink):
    ...
    mode_title = {u'DEFAULT': _(u'Install'), u'LAST': _(u'Install Last'),
                  u'MISSING': _(u'Install Missing Files')}
    mode_help = {u'DEFAULT': _(u'Install selected installer(s)'),
                 u'LAST': _(u'Install the selected installer(s) at the last '
                            u'position'),
