...
settingDefaults = { ##: (178) belongs to bosh (or better to a settings package)
    ...
    #--Colors
    u'bash.colors': {
        # PY3: These colors to be bytes, at least in py2 - verify in py3
        #--Common Colors
        u'default.text':                 b'BLACK',
        u'default.bkgd':                 b'WHITE',
        #--Mods Tab
        u'mods.text.esm':                b'BLUE',
        u'mods.text.mergeable':          (0x00, 0x99, 0x00),
        u'mods.text.noMerge':            (150, 130, 0),
        u'mods.bkgd.doubleTime.exists':  (0xFF, 0xDC, 0xDC),
        u'mods.bkgd.doubleTime.load':    (0xFF, 0x64, 0x64),
        u'mods.bkgd.deactivate':         (0xFF, 0x64, 0x64),
        u'mods.bkgd.ghosted':            (0xE8, 0xE8, 0xE8),
        u'mods.text.eslm':               (123, 29, 223),
        u'mods.text.esl':                (226, 54, 197),
        u'mods.text.bashedPatch':        (30, 157, 251),
        #--INI Edits Tab
        u'ini.bkgd.invalid':             (0xDF, 0xDF, 0xDF),
        u'tweak.bkgd.invalid':           (0xFF, 0xD5, 0xAA),
        u'tweak.bkgd.mismatched':        (0xFF, 0xFF, 0xBF),
        u'tweak.bkgd.matched':           (0xC1, 0xFF, 0xC1),
        #--Installers Tab
        u'installers.text.complex':      b'NAVY',
        u'installers.text.invalid':      b'GREY',
        u'installers.text.marker':       (230, 97, 89),
        u'installers.bkgd.skipped':      (0xE0, 0xE0, 0xE0),
        u'installers.bkgd.outOfOrder':   (0xFF, 0xFF, 0x00),
        u'installers.bkgd.dirty':        (0xFF, 0xBB, 0x33),
        #--Screens Tab
        u'screens.bkgd.image':           (0x64, 0x64, 0x64),
    },
    #--BSA Redirection
    ...
    u'bash.masters.esmsFirst': 1,
    u'bash.masters.selectedFirst': 0,
    ...
    u'bash.installers.conflictsReport.showBSAConflicts': False,
    ...
    u'bash.ini.choices': {},
    u'bash.ini.choice': 0,
    u'bash.ini.allowNewLines': bush.game.ini.allowNewLines,
    #--Wrye Bash: Mods
    ...
    u'bash.mods.esmsFirst': 1,
    u'bash.mods.selectedFirst': 0,
    ...
    #--Tes4View/Edit/Trans
    u'tes4View.iKnowWhatImDoing': False,
    u'tes5View.iKnowWhatImDoing': False,
    u'sseView.iKnowWhatImDoing': False,
    u'fo4View.iKnowWhatImDoing': False,
    u'fo3View.iKnowWhatImDoing': False,
    u'fnvView.iKnowWhatImDoing': False,
    u'enderalView.iKnowWhatImDoing': False,
    u'tes5vrView.iKnowWhatImDoing': False,
    u'fo4vrView.iKnowWhatImDoing': False,
    #--BOSS:
...
modeling_tools_buttons = (
    ...
    (u'Dogwaffle', imageList(u'tools/dogwaffle%s.png'),_(u'Launch Dogwaffle')),
    ...
    (u'Sculptris', imageList(u'tools/sculptris%s.png'),_(u'Launch Sculptris')),
    (u'SpeedTree', imageList(u'tools/speedtree%s.png'),_(u'Launch SpeedTree')),
...
texture_tool_buttons = (
    ...
    (u'Artweaver', imageList(u'tools/artweaver%s.png'),_(u'Launch Artweaver')),
    (u'CrazyBump', imageList(u'tools/crazybump%s.png'),_(u'Launch CrazyBump')),
    (u'DDSConverter', imageList(u'tools/ddsconverter%s.png'),
     _(u'Launch DDSConverter')),
    (u'DeepPaint', imageList(u'tools/deeppaint%s.png'),_(u'Launch DeepPaint')),
    ...
    (u'IrfanView', imageList(u'tools/irfanview%s.png'),_(u'Launch IrfanView')),
    ...
    (u'PhotoSEAM', imageList(u'tools/photoseam%s.png'),_(u'Launch PhotoSEAM')),
...
misc_tools = (
    ...
    (u'Freeplane', imageList(u'tools/freeplane%s.png'),_(u'Launch Freeplane')),
    (u'FileZilla', imageList(u'tools/filezilla%s.png'),_(u'Launch FileZilla')),
