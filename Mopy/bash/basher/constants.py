...
settingDefaults = { ##: (178) belongs to bosh (or better to a settings package)
    ...
    'bash.colors': {
        #--Common Colors
        'default.text':                 b'BLACK',
        'default.bkgd':                 b'WHITE',
        #--Mods Tab
        'mods.text.esm':                b'BLUE',
        ...
        #--Installers Tab
        'installers.text.complex':      b'NAVY',
        'installers.text.invalid':      b'GREY',
    ...
    'bash.mods.ratings': [u'+',u'1',u'2',u'3',u'4',u'5',u'=',u'~'],
    ...
    #--Wrye Bash: Masters
    'bash.masters.cols': [u'File', u'Num', u'Current Order'],
    'bash.masters.esmsFirst': 1,
    'bash.masters.selectedFirst': 0,
    'bash.masters.sort': u'Num',
    ...
    #--Installers
    'bash.installers.cols': [u'Package',u'Order',u'Modified',u'Size',u'Files'],
    'bash.installers.colReverse': {},
    'bash.installers.sort': u'Order',
    ...
    'bash.ini.cols': [u'File',u'Installer'],
    'bash.ini.sort': u'File',
    'bash.ini.colReverse': {},
    ...
    'bash.mods.cols': [u'File', u'Load Order', u'Installer', u'Modified', u'Size',
                       u'Author', u'CRC'],
    'bash.mods.esmsFirst': 1,
    'bash.mods.selectedFirst': 0,
    'bash.mods.sort': u'Load Order',
    ...
    #--Wrye Bash: Saves
    'bash.saves.cols': [u'File',u'Modified',u'Size',u'PlayTime',u'Player',u'Cell'],
    'bash.saves.sort': u'Modified',
    ...
    #Wrye Bash: BSAs
    'bash.BSAs.cols': [u'File', u'Modified', u'Size'],
    ...
    'bash.BSAs.sort': u'File',
    #--Wrye Bash: Screens
    'bash.screens.cols': [u'File', u'Modified', u'Size'],
    'bash.screens.sort': u'File',
    ...
    #--Wrye Bash: People
    'bash.people.cols': [u'Name',u'Karma',u'Header'],
    'bash.people.sort': u'Name',
...
texture_tool_buttons = (
    ...
    ('Krita', imageList(u'tools/krita%s.png'), _(u'Launch Krita')),
