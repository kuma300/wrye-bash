...
def InitModLinks():
    ...
    if bush.game.esp.canBash:
        ...
        for ex_link_name in bush.game.export_links:
            exportMenu.links.append(globals()[ex_link_name]())
        ModList.itemMenu.append(exportMenu)
        #--Import
        importMenu = MenuLink(_(u"Import"))
        for in_link_name in bush.game.import_links:
            importMenu.append(globals()[in_link_name]())
