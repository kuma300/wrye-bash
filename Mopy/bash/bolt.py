...
def encode_complex_string(string_val, max_size=None, min_size=None,
    ...
    if min_size and len(string_val) < min_size:
        string_val += '\x00' * (min_size - len(string_val))
    return string_val
...
class CIstr(unicode):
    ...
    #--repr
    def __repr__(self):
        return u'{0}({1})'.format(type(self).__name__,
...
class DefaultLowerDict(LowerDict, collections.defaultdict):
    ...
    def __repr__(self):
        return u'{0}({1},{2})'.format(
            type(self).__name__, self.default_factory,
    ...
    def temp(self,unicodeSafe=True):
        ...
        if unicodeSafe:
            try:
                ...
                ret = unicode(self._s.encode(u'ascii', u'xmlcharrefreplace'),
